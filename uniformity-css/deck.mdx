...
<Appear>
  ...
  <div>Zmusić zespół do pracy w zespole</div>
...
- Plaski kod
- Latwo zorientowac się czego dotyczy dana klasa
...
- Piszemy w js 👃
- Obciążamy event-loop w js przez co spowalniamy dzialanie aplikacji 🖕
